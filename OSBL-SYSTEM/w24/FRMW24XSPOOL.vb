...
Public Class FRMW24XSPOOL
    ...
    Private Sub GENERARToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles GENERARToolStripMenuItem.Click
        Try
            ...
            Dim tb As New CYPLUSDataSetTableAdapters.selec_proc_linea_w24TableAdapter


            tb.Fill(dst.Tables("selec_proc_linea_w24"), TXTISOMETRICO.Text, TXTSPOOL.Text)

            Dim rep As New rpw24xspool
    ...
    Private Sub FRMW24XSPOOL_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
