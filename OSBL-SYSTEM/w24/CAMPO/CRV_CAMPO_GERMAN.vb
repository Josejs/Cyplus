...
Public Class CRV_CAMPO_GERMAN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.CRV_CAMPO_GERMAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRV_CAMPO_GERMAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRV_CAMPO_GERMAN = New CRV_CAMPO_GERMAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
