...
Public Class W24PERIODOS
    ...
    Private Sub GENERARToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles GENERARToolStripMenuItem.Click
        Try
            ...
            Dim tb As New CYPLUSDataSetTableAdapters.selec_proc_linea_JUNTAS_CAMPO_periodoTableAdapter


            tb.Fill(dst.Tables("selec_proc_linea_JUNTAS_CAMPO_periodo"), dtfech.Text, DateTimeInput1.Text)

            Dim rep As New CRW24PERIODOS
