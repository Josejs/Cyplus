...
Public Class W24CAMPOFECHA
    ...
    Private Sub GENERARToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles GENERARToolStripMenuItem.Click
        Try
            ...
            Dim tb As New CYPLUSDataSetTableAdapters.selec_proc_linea_JUNTAS_CAMPOTableAdapter


            tb.Fill(dst.Tables("selec_proc_linea_JUNTAS_CAMPO"), dtfech.Text)

            Dim rep As New CRVW24CAMPO
