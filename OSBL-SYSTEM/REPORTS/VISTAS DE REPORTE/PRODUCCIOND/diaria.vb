...
Public Class diaria
    ...
    Private Sub GENERARToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GENERARToolStripMenuItem.Click
        Try
            ...
            Dim tb As New CYPLUSDataSetTableAdapters.SELECT_PRODUCCION_FECHATableAdapter


            tb.Fill(dst.Tables("SELECT_PRODUCCION_FECHA"), dtfech.Text)

            Dim rep As New RPDIARIAFECHA
