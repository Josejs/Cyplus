...
Public Class RPESTADOSPOOL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPESTADOSPOOL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPESTADOSPOOL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPESTADOSPOOL = New RPESTADOSPOOL()
        rpt.Site = Me.Site
        Return rpt
    End Function
