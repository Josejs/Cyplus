...
Public Class RPISOMESPECIF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPISOMESPECIF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPISOMESPECIF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPISOMESPECIF = New RPISOMESPECIF()
        rpt.Site = Me.Site
        Return rpt
    End Function
