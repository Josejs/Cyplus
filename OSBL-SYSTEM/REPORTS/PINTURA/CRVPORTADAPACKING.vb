...
Public Class CRVPORTADAPACKING
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.CRVPORTADAPACKING.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVPORTADAPACKING
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVPORTADAPACKING = New CRVPORTADAPACKING()
        rpt.Site = Me.Site
        Return rpt
    End Function
