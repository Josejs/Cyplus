...
Public Class CRV_VALE_REPORTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.CRV_VALE_REPORTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRV_VALE_REPORTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRV_VALE_REPORTE = New CRV_VALE_REPORTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
