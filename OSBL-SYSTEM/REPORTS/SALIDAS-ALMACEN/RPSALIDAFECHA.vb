...
Public Class RPSALIDAFECHA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPSALIDAFECHA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPSALIDAFECHA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPSALIDAFECHA = New RPSALIDAFECHA()
        rpt.Site = Me.Site
        Return rpt
    End Function
