...
Public Class RPSALIDASTOTAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPSALIDASTOTAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPSALIDASTOTAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPSALIDASTOTAL = New RPSALIDASTOTAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
