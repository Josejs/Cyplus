...
Public Class frmdailycondicion
    ...
    Private Sub GENERARToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GENERARToolStripMenuItem.Click
        Try
            ...
            Dim tb As New CYPLUSDataSetTableAdapters.SELECCION_QUERY_DAILY_SPOOL_CONDICIONTableAdapter


            tb.Fill(dst.Tables("SELECCION_QUERY_DAILY_SPOOL_CONDICION"), CBISOMETRICO.Text, CBSPOOL.Text)

            Dim rep As New RPCONDICIONSPOOLDAILY
