...
Public Class query_por_iso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.query_por_iso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedquery_por_iso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As query_por_iso = New query_por_iso()
        rpt.Site = Me.Site
        Return rpt
    End Function
