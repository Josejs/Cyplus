...
Public Class RPDIARIAFECHA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPDIARIAFECHA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPDIARIAFECHA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPDIARIAFECHA = New RPDIARIAFECHA()
        rpt.Site = Me.Site
        Return rpt
    End Function
