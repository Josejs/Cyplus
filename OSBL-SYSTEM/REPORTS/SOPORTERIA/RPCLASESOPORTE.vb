...
Public Class RPCLASESOPORTE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPCLASESOPORTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPCLASESOPORTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPCLASESOPORTE = New RPCLASESOPORTE()
        rpt.Site = Me.Site
        Return rpt
    End Function
