...
Public Class RPEXISTENCIAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPEXISTENCIAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPEXISTENCIAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPEXISTENCIAS = New RPEXISTENCIAS()
        rpt.Site = Me.Site
        Return rpt
    End Function
