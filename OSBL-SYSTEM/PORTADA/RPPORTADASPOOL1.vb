...
Public Class RPPORTADASPOOLs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPPORTADASPOOL.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedRPPORTADASPOOLs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPPORTADASPOOL = New RPPORTADASPOOL()
        rpt.Site = Me.Site
        Return rpt
    End Function
