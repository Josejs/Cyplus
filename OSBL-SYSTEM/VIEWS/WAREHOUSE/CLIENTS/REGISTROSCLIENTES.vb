...
#End Region
    ...
    Private Sub REGISTROSCLIENTES_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If CheckBox1.Checked = True Then
                LlamarDatos("SELECT * FROM CLIENTES ")
                DT = New DataTable
                ADP.Fill(DT)
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        If RadioButton1.Checked Then
            LlamarDatos("SELECT * FROM CLIENTES WHERE CODIGO_CLIENTE LIKE '%" & TextBox1.Text & "%' ")
            DT = New DataTable
