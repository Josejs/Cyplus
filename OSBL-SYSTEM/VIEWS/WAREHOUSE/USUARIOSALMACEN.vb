...
Public Class USUARIOSALMACEN
#Region "Metodos"
    Sub LlenarGrid()

        Try
            CONECTARBD()
            CADENA = "Select*from USUARIO_ALMACEN"
    ...
    End Sub
#End Region
    Private Sub USUARIOSALMACEN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LlenarGrid()
    End Sub
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX1.Click
        Try
            CONECTARBD()
            COMANDO = New SqlCommand("INS_USUARIO_ALM", CN)
    ...
    Private Sub ButtonX2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX2.Click
        ...
        Else
            Try
                ...
                CONECTARBD()
                COMANDO = New SqlCommand("EDIT_USU_ALM", CN)
                COMANDO.CommandType = CommandType.StoredProcedure
    ...
    Private Sub ButtonX3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX3.Click
        ...
        Else
            Try
                CONECTARBD()
                COMANDO = New SqlCommand("ELIM_USU_ALM", CN)
                COMANDO.CommandType = CommandType.StoredProcedure
