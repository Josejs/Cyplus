...
#End Region
    ...
    Private Sub FRMFALTAMAT_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try

            LlamarDatos("EXEC SP_FALTA_MATERIAL")
            DT = New DataTable
            ADP.Fill(DT)
