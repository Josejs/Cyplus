...
#Region "Metodos"
    ...
    End Sub
#End Region
    Private Sub USUARIOSPRINCIPAL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LlenarGrid()
    End Sub
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX1.Click
        Try
            CONECTARBD()
            COMANDO = New SqlCommand("INS_USUARIO_PRINC", CN)
    ...
    Private Sub ButtonX2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX2.Click
        ...
        Else
            Try
                ...
                CONECTARBD()
                COMANDO = New SqlCommand("EDIT_USU_PRINC", CN)
                COMANDO.CommandType = CommandType.StoredProcedure
    ...
    Private Sub ButtonX3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX3.Click
        ...
        Else
            Try
                CONECTARBD()
                COMANDO = New SqlCommand("ELIM_USU_PRINC", CN)
                COMANDO.CommandType = CommandType.StoredProcedure
