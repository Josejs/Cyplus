...
Public Class RPCONSECUTIVO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.RPCONSECUTIVO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPCONSECUTIVO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPCONSECUTIVO = New RPCONSECUTIVO()
        rpt.Site = Me.Site
        Return rpt
    End Function
