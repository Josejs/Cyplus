...
#End Region
    ...
    Private Sub FRMEDO_SPOOL_MTS_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            LlamarDatos("EXEC edo_spool_mts2")
            DT = New DataTable
            ADP.Fill(DT)
        ...
        End Try
        ToolStripStatusLabel1.Text = Me.DataGridView1.Rows.Count & " REGISTROS"
    End Sub
