...
Public Class REGISTROS_HISTORIAL
#Region "METODOS"
...
#End Region
    ...
    Private Sub TextBox2_TextChanged(sender As System.Object, e As System.EventArgs) Handles TextBox2.TextChanged
        If RadioButton2.Checked Then
            LlamarDatos("SELECT * FROM HISTORIAL_JUNTAS WHERE NUMERO_ISO LIKE '%" & TextBox2.Text & "%' ORDER BY NUMERO_ISO ASC")
            DT = New DataTable
    ...
    Private Sub REGISTROS_HISTORIAL_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            If CheckBox2.Checked = True Then
                LlamarDatos("SELECT * FROM HISTORIAL_JUNTAS ")
                DT = New DataTable
                ADP.Fill(DT)
                DataGridView1.DataSource = DT
                TextBox2.Enabled = False
