...
#End Region
    ...
    Private Sub JUNTASRP_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            LlamarDatos("EXEC SP_CUENTA_JUNTAS_PRODUCCION")
            DT = New DataTable
            ADP.Fill(DT)
