...
Public Class CRVFERRITA_ISO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OSBL_SYSTEM.CRVFERRITA_ISO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVFERRITA_ISO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVFERRITA_ISO = New CRVFERRITA_ISO()
        rpt.Site = Me.Site
        Return rpt
    End Function
